                ...
                <div class="card-body portfolio-card contact-card">
                  <div class="top-info">
                    <div class="text">
                      ...
                      <p>I'm here to help if you're searching for a Web developer to bring your idea to life or a developer partner to help take your business to the next level.</p>
                    </div>
                  </div>
                  <div class="contact-area">
                    <div class="leave-comments-area">
                      <div class="comments-box">
                        <form id="contact-form" action="https://marveltheme.com/tf/html/bentofolio-html/../assets/fo-asset/mail.php" method="POST">
                          <div class="row gx-3">
                            <div class="col-md-6">
                              <div class="mb-4">
                    ...
                    <div class="contact-map-area">
                      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d165215.6939026164!2d90.45828529096248!3d23.79064979012561!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1715235967942!5m2!1sen!2sbd" width="600" height="450" style="border:0;" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
...
export default {
  data() {
    return {
      email: '', // Store the entered email address
    };
  },
  methods: {
    async register() {
      // Send a request to your backend API to handle registration
      try {
