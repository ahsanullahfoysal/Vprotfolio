                ...
                <div class="card-body portfolio-card">
                  <div class="portfolio-details-area">
                    <div class="main-image">
                      <img src="../assets/fo-asset/img/projects/Production automation.png" alt="project-details-1">
                    </div>
                    <div class="portfolio-details-text">
                      <div class="short-info">
                        ...
                        <div class="info-item">
                          ...
                          <h4 class="card-title">Production Automation Software</h4>
                      ...
                      <div class="row g-3">
                        <div class="col-md-6">
                          <div class="image-item">
                            <img src="../assets/fo-asset/img/projects/Production-automation (1).png" alt="project-details-2"
                              class="img-fluid w-100">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="image-item">
                            <img src="../assets/fo-asset/img/projects/production-ladger.png" alt="project-details-3"
                              class="img-fluid w-100">
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="prev-and-next-btn">
                      <button class="btn btn-prev"><a href="/details">Previous</a></button>
                      <button class="btn btn-next"><a href="/resdetails">Next</a></button>
                    </div>
                  </div>
