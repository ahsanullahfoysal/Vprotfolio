                    ...
                    <div class="row g-4 parent-container">
                      <div class="col-lg-12">
                        <div class="portfolio-item">
                          ...
                          <div class="text">
                            <div class="info">
                              <a href="/details" class="title">Production Automation Software </a>
                              <p class="subtitle">Raw php mySql javascript jquery</p>
                            </div>
                            <div class="visite-btn">
                              <a href="/details">Visit Site
                      ...
                      <div class="col-lg-12">
                        <div class="portfolio-item">
                          ...
                          <div class="text">
                            <div class="info">
                              <a href="/resdetails" class="title">Resturant Managment (CMS)</a>
                              <p class="subtitle">Laravel</p>
                            </div>
                            <div class="visite-btn">
                              <a href="/resdetails">Visit Site
                                <svg class="arrow-up" width="14" height="15" viewBox="0 0 14 15" fill="none"
                                  xmlns="http://www.w3.org/2000/svg">
                                  <path d="M9.91634 4.5835L4.08301 10.4168" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
                      ...
                      <div class="col-lg-12">
                        <div class="portfolio-item">
                          <div class="image">
                            <img src="../assets/fo-asset/img/projects/vcommerce.png" alt="project-3" class="img-fluid w-100">
                            <a href="../assets/fo-asset/img/projects/vcommerce.png"
                              class="gallery-popup full-image-preview parent-container">
                              <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none"
                                stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                                <path d="M10 4.167v11.666M4.167 10h11.666"></path>
                          ...
                          <div class="text">
                            <div class="info">
                              <a href="/vcommerce" class="title">Coza store E-commerce Software</a>
                              <p class="subtitle"> Development</p>
                            </div>
                            <div class="visite-btn">
                              <a href="/vcommerce">Visit Site
                                <svg class="arrow-up" width="14" height="15" viewBox="0 0 14 15" fill="none"
                                  xmlns="http://www.w3.org/2000/svg">
                                  <path d="M9.91634 4.5835L4.08301 10.4168" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
